...
/******/ 	var hotCurrentHash = "3c00528e662ae65d5d45"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HydratorApp = __webpack_require__(182);
	...
	function configureStore(initialState) {
	  ...
	  if (true) {
	    module.hot.accept(180, function () {
	      var nextReducer = __webpack_require__(180);
	...
	function datasets() {
	  ...
	  switch (action.type) {
	    case _actions.ADD_DATASET:
	      ...
	      return Object.assign([], state, [].concat(_toConsumableArray(state.datasets), [dataset(undefined, action)]));
	    default:
	      return state;
	  }
	}
	
	var hydratorApp = (0, _redux.combineReducers)({
	  datasets: datasets
	});
	
	exports.default = hydratorApp;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AddDataset = __webpack_require__(186);
	
	var _AddDataset2 = _interopRequireDefault(_AddDataset);
	...
	var HydratorApp = function (_Component) {
	  _inherits(HydratorApp, _Component);
	
	  function HydratorApp() {
	    _classCallCheck(this, HydratorApp);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(HydratorApp).apply(this, arguments));
	  }
	
	  _createClass(HydratorApp, [{
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_AddDataset2.default, { onAddClick: function onAddClick(text) {
	            return dispatch((0, _actions.addDataset)(text));
	          } }),
	...
	exports.default = (0, _reactRedux.connect)(select)(HydratorApp);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainSection = function (_Component) {
	  ...
	  _createClass(MainSection, [{
	    key: "render",
	    value: function render() {
	      return _react2.default.createElement("section", { id: "main" });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddDataset = function (_Component) {
	  _inherits(AddDataset, _Component);
	
	  function AddDataset() {
	    _classCallCheck(this, AddDataset);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(AddDataset).apply(this, arguments));
	  }
